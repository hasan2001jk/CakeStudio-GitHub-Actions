...
//
    ...
    public String processOrder(Model model, HttpServletRequest request, HttpServletResponse response) throws MessagingException {
        ...
        // }
        String[] buyerAndCheck = request.getParameterValues("buyer_and_check");
        if (buyerAndCheck != null && buyerAndCheck.length > 6 && buyerAndCheck[6] != null) {
            emailRequest.setVagonNum(buyerAndCheck[6]);
        }
